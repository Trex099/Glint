import sys, os, time, json, datetime, ctypes, subprocess
...
class Utils:
    ...
    def compare_versions(self, vers1, vers2, **kwargs):
        ...
        # Sanitize the pads
        # pad = str(kwargs.get("pad", ""))  # Unused variable
    ...
    def grab(self, prompt, **kwargs):
        ...
        if timeout <= 0:
            if sys.version_info >= (3, 0):
                ...
                return str(input(prompt))  # Python 2 used raw_input, Python 3 uses input
        # Write our prompt
